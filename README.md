...
[Download v0.2.3](https://github.com/ezBuilder/nonya/releases/tag/v0.2.3) | [How it works](docs/HOW-IT-WORKS.ko.md) | [Card news](assets/marketing/cardnews/)
...
7. 진행 재개, 검증 통과, 반복 실패, 사람 승인 필요를 ledger와 알림으로 남긴다.
...
```bash
open https://github.com/ezBuilder/nonya/releases/tag/v0.2.3
```
