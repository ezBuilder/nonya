...
[Download v0.2.4](https://github.com/ezBuilder/nonya/releases/tag/v0.2.4) | [How it works](docs/HOW-IT-WORKS.ko.md) | [Card news](assets/marketing/cardnews/)
...
```bash
open https://github.com/ezBuilder/nonya/releases/tag/v0.2.4
```
